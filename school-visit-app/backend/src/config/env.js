...
export const env = {
  ...
  plannerSpreadsheetId: process.env.GOOGLE_PLANNER_SPREADSHEET_ID || process.env.GOOGLE_SHEETS_SPREADSHEET_ID,
  newSchoolsSheetName: process.env.GOOGLE_NEW_SCHOOLS_SHEET_NAME || "New Schools",
  plannerLogSheetName: process.env.GOOGLE_PLANNER_LOG_SHEET_NAME || "Visit Planner Log",
